export default function DashboardCalendar() {
  return (
    ...
    <div className="lg:flex lg:h-[calc(100vh-7rem)] w-full overflow-auto lg:flex-col">
            <header className="flex items-center justify-between border-b border-gray-200 px-6 py-2 lg:flex-none">
