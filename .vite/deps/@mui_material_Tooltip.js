...
import {
  ...
  useTheme_default,
  useTimeout
} from "./chunk-ROL7MDGW.js";
import {
  Transition_default
} from "./chunk-QQ2ISDUM.js";
import {
  require_react_dom
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    function useTheme3(defaultTheme2 = null) {
      const contextTheme = React11.useContext(_styledEngine.ThemeContext);
...
function ThemeProvider(_ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(ThemeProvider_default, _extends({}, props, {
...
var Tooltip = React10.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React10.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime7.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  const [childNode, setChildNode] = React10.useState();
  const [arrowRef, setArrowRef] = React10.useState(null);
  const ignoreNonTouchEvents = React10.useRef(false);
  ...
  if (true) {
    ...
    } = React10.useRef(openProp !== void 0);
    React10.useEffect(() => {
  ...
  const prevUserSelect = React10.useRef();
  ...
  React10.useEffect(() => stopTouchInteraction, [stopTouchInteraction]);
  ...
  const [, setChildIsFocusVisible] = React10.useState(false);
  ...
  const popperRef = React10.useRef();
  ...
  const popperOptions = React10.useMemo(() => {
  ...
  return (0, import_jsx_runtime8.jsxs)(React10.Fragment, {
    children: [React10.cloneElement(children, childrenProps), (0, import_jsx_runtime7.jsx)(PopperComponent, _extends({
      ...
      }) => (0, import_jsx_runtime7.jsx)(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: (0, import_jsx_runtime8.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow2 ? (0, import_jsx_runtime7.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
